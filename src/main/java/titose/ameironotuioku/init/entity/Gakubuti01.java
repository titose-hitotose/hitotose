...
public class Gakubuti01 extends EntityItemFrame{

	 private static final DataParameter<ItemStack> ITEM = EntityDataManager.<ItemStack>createKey(Gakubuti01.class, DataSerializers.ITEM_STACK);
	    private static final DataParameter<Integer> ROTATION = EntityDataManager.<Integer>createKey(Gakubuti01.class, DataSerializers.VARINT);
	    ...
	    private void removeFrameFromMap(ItemStack stack)
	    {
	        if (!stack.isEmpty())
	        {
	            ...
	            stack.setItemFrame((Gakubuti01)null);
	    ...
	    public static void registerFixesGakubuti01(DataFixer fixer)
	    {
	        fixer.registerWalker(FixTypes.ENTITY, new ItemStackData(Gakubuti01.class, new String[] {"Item"}));
	    }
		...
		public Item setRegistryName(String string) {
